# 2. Geospatial Python Programming {.unnumbered #sec-geospatial-python}
...
4. **Creating Functions** (@sec-creating-functions): Writing reusable code to make your analyses more efficient and reproducible
5. **Urban Analytics** (@sec-urban-analytics): Applied examples using real geospatial datasets for urban and environmental analysis
